---
name: Alibaba Java Coding Guidelines (Huangshan Edition)
source: https://github.com/alibaba/Alibaba-Java-Coding-Guidelines
fork-date: 2026-05-14
note: 阿里巴巴 Java 开发手册黄山版英文 Gitbook 完整版。覆盖编程规约、异常日志、单元测试、安全、MySQL、工程结构。
important: 手册的'应用分层'只规定职责（Controller/Service/Manager/DAO），不规定包路径。具体包结构见 java-conventions.md。
---
