---
name: sdd
description: Spec-driven development 工作流总览。当用户说"先 spec / 先出方案 / 先设计 / 提案"或任务规模 >150 行 / 跨 3+ 文件 / 引入新依赖 / 涉及架构选择时，加载此 skill 了解 sdd plugin 的 12 个命令、产物地图、共享精神（HARD GATE / 拷问 / 卡死保护 / 反作弊 / context hygiene）
---
