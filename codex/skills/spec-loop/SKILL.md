...
3. **Act**: implement the increment. Coding Charter applies (read `../spec-core/references/code-charter.md` before the first keystroke of the run). Write `#### Act` (file-level).
