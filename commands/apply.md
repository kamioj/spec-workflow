...
| flag | 启用项 | 效果 |
|---|---|---|
| `design` | anti-ai-slop | sdd-frontend-dev 读 `skills/workflow/references/frontend-aesthetics.md` |
| `solid` | anti-laziness | agent 读 `skills/workflow/references/agent-principles.md` § 一 |
| `verify` | anti-hallucination | agent 读 `skills/workflow/references/agent-principles.md` § 二 |
